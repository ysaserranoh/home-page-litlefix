<template>
  <div class="contain">
    <div class="row" :class="$vuetify.breakpoint.smAndDown ? '' : ' mt-5'">
      <div class="style-font pb-3 title mb-2 white--text font-weight-bold">Drama</div>
...
export default {
  ...
  methods: {
    async getImages () {
      let result = await axios.get('https://api.themoviedb.org/3/discover/movie?api_key=6f26fd536dd6192ec8a57e94141f8b20&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&with_genres=18')
      if (result) {
